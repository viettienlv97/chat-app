    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className={`w-full input input-bordered h-10 ${
                isSubmit && !validForm.fullname ? 'input-error' : ''
              }`}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setValidForm({
                  ...validForm,
                  username: e.target.value ? true : false
                })
              }}
            />
          </div>
          ...
          <div>
            ...
            `}
              ...
              onChange={(e) =>{
                ...
                setValidForm({
                  ...validForm,
                  confirmPassword: e.target.value ? true : false
                })
              }}
            />
          </div>
          ...
          <div>
            <button
              className="btn btn-block btn-sm mt-3 h-11 hover:text-blue-600"
              disabled={loading}
            >
              {loading ? (
